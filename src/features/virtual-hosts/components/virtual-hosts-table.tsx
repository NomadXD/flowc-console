...
import { virtualHostsColumns as columns } from './virtual-hosts-columns'

type DataTableProps = {
  data: VirtualHostResponse[]
  search: Record<string, unknown>
  navigate: NavigateFn
}

export function VirtualHostsTable({ data, search, navigate }: DataTableProps) {
