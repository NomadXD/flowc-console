...
interface VirtualHostApisTabProps {
  environment: Environment
}

export function VirtualHostApisTab({ environment }: VirtualHostApisTabProps) {
  // Get all deployments for this virtual host
  ...
  if (deployments.length === 0) {
    return (
      <EmptyState
        ...
        description='Deploy your first API to this virtual host to get started.'
      />
    )
  }
