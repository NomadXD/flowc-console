...
interface VirtualHostOverviewProps {
  environment: Environment
}

export function VirtualHostOverview({ environment }: VirtualHostOverviewProps) {
  // Get recent deployments for this virtual host (last 5)
  ...
  return (
    <div className='grid gap-4'>
      ...
      <div className='grid gap-4 md:grid-cols-2 lg:grid-cols-3'>
        <Card>
          <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
            <CardTitle className='text-sm font-medium'>Virtual Host</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Virtual Host Details</CardTitle>
        </CardHeader>
        <CardContent>
      ...
      {environment.tlsConfig ? (
        ...
        <Alert>
          ...
          <AlertDescription>
            No TLS configuration for this virtual host
          </AlertDescription>
        </Alert>
      )}
